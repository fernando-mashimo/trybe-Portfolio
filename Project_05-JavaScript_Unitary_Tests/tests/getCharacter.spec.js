...
describe('9 - Implemente os casos de teste da função `getCharacter`', () => {
  ...
  it('Verifica que a função, quando não recebe nenhum parâmetro, retorna undefined.', () => {
    expect(getCharacter()).toBeUndefined;
  });
  // Teste se a função retorna o objeto correto para o parâmetro 'Arya',
  it('Verifica que a função retorna o objeto correto para o parâmetro "Arya".', () => {
  ...
  it('Verifica que a função retorna o objeto correto para o parâmetro "Brienne".', () => {
  ...
  it('Verifica que a função retorna o objeto correto para o parâmetro "Melissandre".', () => {
  ...
  it('Verifica que o parâmetro não é Case Sensitive, ou seja, independente de conter letras maiúsculas ou minúsculas retorna o mesmo objeto relativo a ele.', () => {
    expect(getCharacter('arYA')).toEqual({
      name: 'Arya Stark',
      class: 'Rogue',
      phrases: [ 'Not today', 'A girl has no name.' ]
  ...
  it('Verifica que ao passar um nome que não está na tabela, a função retorna undefined.', () => {
    expect(getCharacter('MaRioBrOs')).toBeUndefined;
  });
});
