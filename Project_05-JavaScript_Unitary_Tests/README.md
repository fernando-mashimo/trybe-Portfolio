# Project 05: ES6 & Unit Testing!

In this project, I had the chance to write functions and each respective test sets using JEST! 🚀

JEST is a testing framework developed by Meta which enables developers to deliver not only reliable code, but also apply Test Driven Development methodology in a simple and powerful way.

# Mandatory Requirements (written in pt-br)
